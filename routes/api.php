...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::get('/artists-count', [ArtistController::class, 'getArtistCount']);
        ...
        //Music
        Route::get('/songs/{artist_id}/create', [MusicController::class, 'create']);
        Route::get('/songs-count', [MusicController::class, 'getMusicCount']);
